...
def submit_and_evaluate_one_model(
    ...
    for sequence_name in inference_dataset.sequence_infos.keys():
        ...
        if dataset in ["DanceTrack", "SportsMOT", "MOT17", "PersonPath22_Inference", "BFT","Bosch_2","Bosch_1"]:
    ...
    if not is_evaluate:
        ...
        if accelerator.is_main_process:
            ...
            if dataset in ["DanceTrack", "SportsMOT", "MOT17", "BFT","Bosch_2","Bosch_1"]:
            ...
            if dataset in ["DanceTrack", "SportsMOT", "BFT","Bosch_2","Bosch_1"] or (dataset in ["MOT17"] and data_split == "test"):
                args = {
